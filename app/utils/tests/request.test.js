...
describe('request', () => {
  ...
  describe('stubbing successfull response', () => {
    // Before each test, pretend we got a successful resposne
    beforeEach(() => {
  ...
  describe('stubbing a 204 response', () => {
    // Before each test, we provide 204 response
    beforeEach(() => {
    ...
    it('should return null on 204', done => {
      request('/hi')
        .catch(done)
        .then(json => {
  ...
  describe('stubbing error response', () => {
    // Before each test we provide a failed response
    beforeEach(() => {
      const res = new Response('', {
        status: 404,
